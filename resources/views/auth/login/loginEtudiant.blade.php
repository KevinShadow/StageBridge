                    ...
                    <div class="xp-auth-box">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                    <form action="{{route('handleloginetudiant')}}" method="POST">
                                        @method('post')
                                        @csrf
                                        <div class="text-center mb-3">
                                            <h4 class="text-black">Connexion Etudiant !</h4>
                                            {{-- @foreach($etud as $etu)
                                                <p>{{$etu->name}} , {{$etu->email}} ,{{$etu->password}}</p>
                                            @endforeach --}}
                                            <p class="text-muted">Nouveau sur StageBridge? <a href="{{route('registeretudiant')}}">S'inscrire</a> Ici</p>
                                        </div>
