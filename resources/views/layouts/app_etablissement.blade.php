        ...
        <div class="xp-leftbar">
            ...
            <div class="xp-sidebar">
                ...
                <div class="xp-logobar text-center">
                    <a href="index.html" class="xp-logo text-primary">StageBridge</a>
                </div>
                <!-- End XP Logobar -->
                ...
                <div class="xp-navigationbar">
                    <ul class="xp-vertical-menu">
                        ...
                        <li>
                            <a href="{{ route('etablissementdashboard') }}">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="index.html" class="nav-item nav-link">STAGE</a>
                        {{-- <a href="index.html" class="nav-item nav-link">EMPLOI</a> --}}
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        <h4 class="text-white mb-4"><i class="fas fa-star-of-life me-3"></i>StageBridge</h4>
