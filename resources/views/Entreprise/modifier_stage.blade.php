...
<head>
    ...
    <title>Modifier Offre - StageBridge</title>
    <!-- Fevicon -->
...
<body class="xp-vertical">
    <div id="xp-container">
        ...
        <div class="xp-breadcrumbbar text-center">
            <h4 class="page-title">Modifier une offre de stage</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}">HOME</a></li>
                <li class="breadcrumb-item active" aria-current="page">Modifier Offre</li>
            </ol>
        </div>
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white text-center">
                            ...
                            <h3>Modifier Stage Académique</h3>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('offre.modifier', $offre->id_stage) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="titre">Titre de l'Offre <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="titre" name="titre" placeholder="Entrer le titre" value="{{ old('titre', $offre->titre) }}" required>
                                    @error('titre')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="domaine" name="domaine" placeholder="Entrer le domaine" value="{{ old('domaine', $offre->domaine) }}" required>
                                    @error('domaine')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="5" placeholder="Qu'est-ce que vous attendez des postulants ?" required>{{ old('description', $offre->description) }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="competence_requis" name="competence_requis" rows="5" placeholder="Compétences attendues (sous forme de tirets)" required>{{ old('competence_requis', $offre->competence_requis) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" placeholder="Adresse" value="{{ old('location', $offre->location) }}" required>
                                    @error('location')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
