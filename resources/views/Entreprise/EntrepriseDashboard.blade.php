    ...
    <div id="xp-container">
                        ...
                        <li>
                            {{-- <a href="javaScript:void();">
                             ...
                             <ul class="xp-vertical-submenu">
                                <li>
                                    <a href="index.html">gerer mes offres poster</a>
                                </li>
                                <li><a href="dashboard-2.html">Dashboard 2</a></li>
                                <li><a href="dashboard-3.html">Dashboard 3</a></li>
                            </ul> --}}
                            <a href="{{ route('mesoffrespublier') }}"> <i class="mdi mdi-view-dashboard"></i>Gerer mes offres poster</a>
                        </li>
                        <li>
                            {{-- <a href="javaScript:void();">
        ...
        <div class="xp-rightbar">
            ...
            <div class="xp-breadcrumbbar text-center ">
                <h4 class="page-title">Entreprise Dashboard</h4>
                  <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" >
                    <li class="breadcrumb-item"><a href="{{route('home')}}">HOME</a></li>
                    <!-- <li class="breadcrumb-item"><a href="#">Extra Pages</a></li> -->
                    <li class="breadcrumb-item active" aria-current="page">Entreprise Dashboard</li>
                  </ol>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ route('disconnect_entreprise') }}" class="nav-item nav-link">Se Deconnecter</a>
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">poster une offres</a>
                            <div class="dropdown-menu m-0">
                                <a href="{{route('creeremploi')}}" class="dropdown-item">d'Emploi</a>
                                <a href="{{ route('creerstage') }}" class="dropdown-item">de stage Academique</a>
                    ...
                    <div class="container py-5">
                        ...
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="blog-item rounded">
                                    <div class="blog-img">
                                        <img src="{{asset('image/'.$emploi->image)}}" class="img-fluid w-100" style="height: 250px;" alt="Image">
                                    </div>
                                    <div class="blog-centent p-4">
                                        <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <p class="my-4">{{ $emploi->description }}</p>
                                        <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Read More</a>
                                    </div>
                                </div>
                            </div>
