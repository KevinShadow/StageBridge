    ...
    <div id="xp-container">
            ...
            <div class="xp-sidebar">
                ...
                <div class="xp-navigationbar">
                    <ul class="xp-vertical-menu">
                        ...
                        <li>
                            <a href="{{ route('mesoffrespostuler') }}">
                              <i class="mdi mdi-view-dashboard"></i><span>mes offres postuller</span><span class="badge badge-pill badge-primary pull-right"></span>
                            </a>
        ...
        <div class="xp-rightbar">
            ...
            <div class="xp-breadcrumbbar text-center ">
                <h4 class="page-title">Etudiant Dashboard</h4>
                  <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" >
                    <li class="breadcrumb-item"><a href="{{route('home')}}">HOME</a></li>
                    <!-- <li class="breadcrumb-item"><a href="#">Extra Pages</a></li> -->
                    <li class="breadcrumb-item active" aria-current="page">Etudiant Dashboard</li>
                  </ol>
            </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ route('disconnect_etudiant') }}" class="nav-item nav-link">Se Deconnecter</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="{{ route('mesoffrespostuler') }}" class="dropdown-item">mes offres postuler</a>
                                <a class="dropdown-item" href="{{ route('profil.etudiant') }}">Mon Profil</a>
                    ...
                    <li class="list-inline-item mr-0">
                        <div class="dropdown xp-userprofile">
                            ...
                            {{-- @if($profil->image)
                                    <a class="dropdown-toggle user-profile-img " href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('imageProfil/' . $profil->image) }}" alt="user-profile" style="height: 40px; width: 40px; object-fit: cover;" class="rounded-circle img-fluid"><span class="xp-user-live"></span></a>
                            @else
                            ...
                            @if(isset($profil) && $profil->image)
                                <a class="dropdown-toggle user-profile-img" href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ asset('imageProfil/' . $profil->image) }}" alt="user-profile" style="height: 40px; width: 40px; object-fit: cover;" class="rounded-circle img-fluid">
                                    <span class="xp-user-live"></span>
                                </a>
                            @else
                                <a class="dropdown-toggle user-profile-img" href="#" role="button" id="xp-userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ asset('style/assets/images/topbar/user.jpg') }}" alt="user-profile" class="rounded-circle img-fluid">
                                    <span class="xp-user-live"></span>
                                </a>
                            @endif
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="xp-userprofile">
                                <a class="dropdown-item" href="#">Bienvenu, @auth('etudiant')
                                    {{ Auth::guard('etudiant')->user()->nom }}
                                @endauth</a>
                                <a class="dropdown-item" href="{{ route('profil.etudiant') }}"><i class="mdi mdi-account mr-2"></i> Profile</a>
                                ...
                                <a class="dropdown-item" href="{{ route('disconnect_etudiant') }}"><i class="mdi mdi-logout mr-2"></i>Se Deconnecter</a>
                            </div>
                        </div>
                    </li>
